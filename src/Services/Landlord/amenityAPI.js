...
export const getAllAmenities = async (searchQuery = "", pageIndex = 1, pageSize = 10) => {
  try {
    ...
    const response = await axiosClient.get(`/api/roomamenty/getallamenties?${params.toString()}`, {
      headers: {
