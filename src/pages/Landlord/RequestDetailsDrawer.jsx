...
//         try {
//             if (!requestData) {
//                 showToast('error', 'Error', 'No request data available');
//                 setIsLoading(false);
//                 return;
//             }
...
//                 showToast('error', 'Error', 'Missing required fields');
//                 setIsLoading(false);
//                 return;
//             }
...
//                 showToast('success', 'Success', 'Room rental request has been approved successfully');
//                 // Rest of your code...
//             } else {
//                 // Hiển thị thông báo lỗi với thông tin từ server
//                 showToast('error', 'Error', response?.message || "Cannot approve room rental request");
//             }
//         } catch (error) {
//             console.error("Error approving room rental request:", error);
    
//             // Hiển thị thông báo lỗi chi tiết từ API
//             showToast('error', 'Error', error.response?.data?.message || error.message || "An unexpected error occurred. Please try again later.");
//         } finally {
//             setIsLoading(false);
//         }
//     };
...
//                                     <Text style={{ fontSize: '16px' }}>{requestData.budgetRange} VNĐ</Text>
//                                 </div>
//                             )}
