...
import { Card, Typography, Descriptions, Image, Button, Spin, Avatar } from "antd";
    ...
    return (
        <div className="rented-room-detail-container">
            <Card className="rented-room-card-container">
                ...
                <Title level={2} className="rented-room-title">Rented Room Details</Title>

                <div className="rented-room-content">
                    <div className="rented-room-left">
                        <Descriptions bordered column={1}>
                            <Descriptions.Item label="Room"><strong>{room.roomTitle}</strong></Descriptions.Item>
                            <Descriptions.Item label="Room Number"><strong>{room.roomNumber}</strong></Descriptions.Item>
                            <Descriptions.Item label="Location"><strong>{room.location}</strong></Descriptions.Item>
                            <Descriptions.Item label="Square"><strong>{room.square} m²</strong></Descriptions.Item>
                            <Descriptions.Item label="Max Members"><strong>{room.maxMembers}</strong></Descriptions.Item>
                            <Descriptions.Item label="Price"><strong>{room.price} VNĐ</strong></Descriptions.Item>
                            <Descriptions.Item label="Deposit"><strong>{room.deposit}</strong></Descriptions.Item>
                            <Descriptions.Item label="Description"><strong>{room.description}</strong></Descriptions.Item>
                        </Descriptions>

                        {/* Services Section */}
                        <div className="rented-room-services">
                            <Title level={4} className="rented-room-services-title">Services</Title>
                            <ul className="rented-room-service-list">
                                {room.services.map((service, index) => (
                                    <li key={index} className="rented-room-service-item">
                                        <span className="rented-room-service-name">{service.name}</span>
                                        <span className="rented-room-service-price">{service.price}</span>
                                    </li>
                                ))}
                            </ul>
